...
public class TracksParser {
    ...
    private List<Track> tracksFromJson(final JSONArray json) throws JSONException, MalformedURLException {
    ...
    private Track trackFromJson(final JSONObject json) throws JSONException, MalformedURLException {
        String title = json.getString("title");
        Url waveformUrl = new Url(json.getString("waveform_url"));
